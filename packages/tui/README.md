...
pi-tui, the terminal UI library from [pi](https://github.com/earendil-works/pi) by Mario Zechner (MIT License), cut down to what pi-lite uses:
...
The package exports its TypeScript sources directly (`src/index.ts`). Node runs them with type stripping, and pi-lite's build bundles them.
