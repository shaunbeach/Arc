/** Written by `pi-lite --init`. The README's models.yml section documents every field. */
export const STARTER_MODELS_YML = `# pi-lite models. Pick one with "pi-lite -m <name>" or /model, and pi-lite
