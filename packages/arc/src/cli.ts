...
Interactive commands: /agent  /plan  /chat  /web [on|off]  /rag [on|off]  /ponytail [off|lite|full|ultra]  /model [name]  /mode [thinking|instruct]  /serve [name]  /disconnect  /compact  /clear  /resume [number|name|id]  /name <text>  /quit
`;
