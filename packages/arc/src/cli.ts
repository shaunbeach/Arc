...
Interactive commands: /agent  /plan  /chat  /web [on|off]  /rag [on|off]  /model [name]  /mode [thinking|instruct]  /serve [name]  /disconnect  /compact  /clear  /resume [number|name|id]  /name <text>  /quit
`;
