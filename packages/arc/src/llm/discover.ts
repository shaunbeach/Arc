 ...
 * carries is here except the reply reserve, which is Arc's own budgeting choice rather than a server fact.
 */
export interface ServerProps {
	/** `-m` as the server received it. The identity Arc matches on. */
	modelPath: string;
